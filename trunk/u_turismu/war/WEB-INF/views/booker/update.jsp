...
<body>
	<div id="mainPage">
		...
		<div id="contentPage">
			<div id="content" class="update content box">
			
				<sf:form id="updateForm" action="update?newBo" method="post" commandName="update">
					<table>
						<tr>
							<td><label class="label">Email</label></td>
							<td><sf:input disabled="true" path="email" value="${update.email}" class="fieldIN" /></td>
							<td><sf:errors path="email" cssClass="error" /></td>
						</tr>
						<tr>
							<td><label class="label">Password</label></td>
							<td><sf:password disabled="true" path="password" value="${update.password}" class="fieldIN" /></td>
